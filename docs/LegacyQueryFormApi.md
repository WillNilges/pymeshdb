...
> PaginatedQueryFormList api_v1_query_buildings_list(password, bin=bin, city=city, page=page, state=state, street_address=street_address, zip_code=zip_code)
...
with pymeshdb.ApiClient(configuration) as api_client:
    ...
    try:
        # Query & filter based on Building attributes. Results are returned as flattened spreadsheet row style output
        api_response = api_instance.api_v1_query_buildings_list(password, bin=bin, city=city, page=page, state=state, street_address=street_address, zip_code=zip_code)
...
> PaginatedQueryFormList api_v1_query_installs_list(password, building=building, install_number=install_number, member=member, network_number=network_number, page=page, status=status)
...
with pymeshdb.ApiClient(configuration) as api_client:
    ...
    api_instance = pymeshdb.LegacyQueryFormApi(api_client)
    password = 'password_example' # str | The password for the legacy query form
    building = 56 # int |  (optional)
    install_number = 56 # int |  (optional)
    member = 56 # int |  (optional)
    ...
    try:
        # Query & filter based on Install attributes. Results are returned as flattened spreadsheet row style output
        api_response = api_instance.api_v1_query_installs_list(password, building=building, install_number=install_number, member=member, network_number=network_number, page=page, status=status)
...
> PaginatedQueryFormList api_v1_query_members_list(password, email_address=email_address, name=name, page=page, phone_number=phone_number)
...
with pymeshdb.ApiClient(configuration) as api_client:
    ...
    try:
        # Query & filter based on Member attributes. Results are returned as flattened spreadsheet row style output
        api_response = api_instance.api_v1_query_members_list(password, email_address=email_address, name=name, page=page, phone_number=phone_number)
