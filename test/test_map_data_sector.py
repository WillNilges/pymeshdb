...
class TestMapDataSector(unittest.TestCase):
    """MapDataSector unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MapDataSector:
        """Test MapDataSector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapDataSector`
        """
        model = MapDataSector()
        if include_optional:
            return MapDataSector(
                node_id = 56,
                radius = 0,
                azimuth = 0,
                width = 0,
