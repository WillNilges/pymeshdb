...
class TestInstallMember(unittest.TestCase):
    """InstallMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstallMember:
        """Test InstallMember
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstallMember`
        """
        model = InstallMember()
        if include_optional:
