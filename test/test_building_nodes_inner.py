...
class TestBuildingNodesInner(unittest.TestCase):
    """BuildingNodesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildingNodesInner:
        """Test BuildingNodesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildingNodesInner`
        """
        model = BuildingNodesInner()
        if include_optional:
            return BuildingNodesInner(
                id = '',
    ...
    def testBuildingNodesInner(self):
        """Test BuildingNodesInner"""
