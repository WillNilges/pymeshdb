...
class TestPatchedAccessPoint(unittest.TestCase):
    """PatchedAccessPoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedAccessPoint:
        """Test PatchedAccessPoint
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedAccessPoint`
        """
        model = PatchedAccessPoint()
        if include_optional:
            return PatchedAccessPoint(
                id = '',
                links_from = [
    ...
    def testPatchedAccessPoint(self):
        """Test PatchedAccessPoint"""
