...
class TestNetworkNumberAssignmentRequest(unittest.TestCase):
    """NetworkNumberAssignmentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkNumberAssignmentRequest:
        """Test NetworkNumberAssignmentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkNumberAssignmentRequest`
        """
        model = NetworkNumberAssignmentRequest()
        if include_optional:
            return NetworkNumberAssignmentRequest(
                password = '',
                install_number = 56
            )
        else:
    ...
    def testNetworkNumberAssignmentRequest(self):
        """Test NetworkNumberAssignmentRequest"""
