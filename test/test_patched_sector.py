...
class TestPatchedSector(unittest.TestCase):
    """PatchedSector unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedSector:
        """Test PatchedSector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedSector`
        """
        model = PatchedSector()
        if include_optional:
            return PatchedSector(
                id = '',
                latitude = 1.337,
                longitude = 1.337,
                altitude = 1.337,
