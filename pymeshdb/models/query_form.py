...
class QueryForm(BaseModel):
    ...
    network_number_status: Optional[StrictStr]
    ...
    __properties: ClassVar[List[str]] = ["install_number", "street_address", "unit", "city", "state", "zip_code", "name", "phone_number", "additional_phone_numbers", "primary_email_address", "stripe_email_address", "additional_email_addresses", "notes", "network_number", "network_number_status", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if network_number_status (nullable) is None
        # and model_fields_set contains the field
        if self.network_number_status is None and "network_number_status" in self.model_fields_set:
            _dict['network_number_status'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "network_number_status": obj.get("network_number_status"),
