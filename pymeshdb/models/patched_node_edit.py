...
class PatchedNodeEdit(BaseModel):
    """
    ...
    buildings: Optional[List[NodeBuildingsInner]] = None
    devices: Optional[List[NodeDevicesInner]] = None
    ...
    status: Optional[Status2a6Enum] = Field(default=None, description="The current status of this Node  * `Inactive` - Inactive * `Active` - Active * `Planned` - Planned")
    type: Optional[Type1bfEnum] = Field(default=None, description="The type of node this is, controls the icon used on the network map  * `Standard` - Standard * `Hub` - Hub * `Supernode` - Supernode * `POP` - POP * `AP` - AP * `Remote` - Remote")
    latitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Approximate Node latitude in decimal degrees (this will match one of the attached Building objects in most cases, but has been manually moved around in some cases to more accurately reflect node location)")
    longitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Approximate Node longitude in decimal degrees (this will match one of the attached Building objects in most cases, but has been manually moved around in some cases to more accurately reflect node location)")
