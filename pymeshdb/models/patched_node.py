...
class PatchedNode(BaseModel):
    ...
    buildings: Optional[List[StrictInt]] = None
    ...
    status: Optional[NodeStatusEnum] = Field(default=None, description="The current status of this Node  * `Inactive` - Inactive * `Active` - Active * `Planned` - Planned")
