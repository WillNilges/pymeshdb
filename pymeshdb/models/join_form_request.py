...
class JoinFormRequest(BaseModel):
    ...
    referral: StrictStr
    ncl: StrictBool
    trust_me_bro: StrictBool
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "email_address", "phone_number", "street_address", "city", "state", "zip_code", "apartment", "roof_access", "referral", "ncl", "trust_me_bro"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ncl": obj.get("ncl"),
            "trust_me_bro": obj.get("trust_me_bro")
        })
        return _obj
