...
class GeographicKMLDataApi:
    ...
    def api_v1_geography_nyc_geocode_v2_search_retrieve(
        ...
        zip: Annotated[str, Field(min_length=1, strict=True)],
    ...
    @validate_call
    def api_v1_geography_whole_mesh_kml_retrieve(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._api_v1_geography_whole_mesh_kml_retrieve_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def api_v1_geography_whole_mesh_kml_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_v1_geography_whole_mesh_kml_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _api_v1_geography_whole_mesh_kml_retrieve_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/geography/whole-mesh.kml',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
