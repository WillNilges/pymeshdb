...
class SectorsApi:
    ...
    def api_v1_sectors_create(
        ...
        _param = self._api_v1_sectors_create_serialize(
            sector=sector,
    ...
    @validate_call
    def api_v1_sectors_create_with_http_info(
        self,
        sector: Sector,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_sectors_create_without_preload_content(
        self,
        sector: Sector,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_sectors_create_serialize(
        self,
        sector,
        _request_auth,
        _content_type,
    ...
    def api_v1_sectors_destroy(
        ...
        _param = self._api_v1_sectors_destroy_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v1_sectors_destroy_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def _api_v1_sectors_lookup_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/sectors/lookup/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api_v1_sectors_partial_update(
        ...
        _param = self._api_v1_sectors_partial_update_serialize(
            id=id,
            patched_sector=patched_sector,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _api_v1_sectors_partial_update_serialize(
        self,
        id,
        patched_sector,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if patched_sector is not None:
            _body_params = patched_sector
    ...
    def api_v1_sectors_retrieve(
        ...
        _param = self._api_v1_sectors_retrieve_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v1_sectors_retrieve_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def api_v1_sectors_update(
        ...
        _param = self._api_v1_sectors_update_serialize(
            id=id,
            sector=sector,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _api_v1_sectors_update_serialize(
        self,
        id,
        sector,
        _request_auth,
